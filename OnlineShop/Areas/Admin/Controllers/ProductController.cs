...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(Products products, IFormFile image,int id,object sender,EventArgs e)
        {
            if (ModelState.IsValid)
            {
                if (image != null)
                ...
                if (image == null)
                {
                    ...
                    var name = _db.Products.FirstOrDefault(c => c.Image == products.Image);
                    
                    //await image.CopyToAsync(new FileStream(name, FileMode.Create));
                    products.Image = "Images/" + name;
                }
